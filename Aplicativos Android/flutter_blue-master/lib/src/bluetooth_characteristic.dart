...
class BluetoothCharacteristic {
  ...
  List<int> list_valores = new List();
...
//        _value.add(c.lastValue);
          // ordem++;
          //print(list_valores);
          // if(list_valores.length > 30){
          //   tempo = stopwatch.elapsedMilliseconds;
          //   contador++;
          //   media_tempo += tempo;
            // print('30 bytes lidos em ${tempo} ms');
            // print('média: ${media_tempo/contador} ms');
            // stopwatch..reset();
            // print('list_valores: ${list_valores}');
          //   list_valores = [];
          //   ordem = 0;
          // }
          // list_valores = List.from(c.lastValue)..addAll(list_valores);
          // print('c.lastValue: ${new String.fromCharCodes(c.lastValue)}');
